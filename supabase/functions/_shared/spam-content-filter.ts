/** Server-side spam scrub — mirrors client apps/web/src/lib/spam-content-filter.ts */
...
export function scrubSpamFromText(input: string, options: { trim?: boolean } = {}): SpamFilterResult {
...
export function scrubSpamFromHtml(html: string): SpamFilterResult {
  ...
  return { text: scrubbed, removed: [...new Set(removed)], changed: changed || scrubbed !== html };
}
